                ...
                <div class="my-card">
                    ...
                    <div class="my-card__top">
                        <div class="my-card__picture-wrapper">
                            <span class="svg-picture"> ${svgPicture} </span>
                        </div>
                        <span class="txt-buttons txt">${nameUserCard}</span>
                        <div class="my-card__edit to-edit">${editCardSvg}</div>
                    </div>
                    <div class="my-card__main">
                        <div class="my-card__wish-wrapper">
                            <div class="my-card__wish">
                                <span class="show-contact hidden"> ${contactsCard} </span>
                                <span class="show-wish"> ${wishesCard} </span>
                            </div>
                        </div>
                    </div>
